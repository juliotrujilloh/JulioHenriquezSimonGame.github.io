...
function playSound(name) {
  var sound = new Audio('https://github.com/juliotrujilloh/JulioHenriquezSimonGame.github.io/blob/gh-pages/sounds/'+name+'.mp3');
  sound.play();
}
  ...
  if (userClickedPattern.length !== gamePattern.length) {
    for (var i = 0; i < userClickedPattern.length; i++) {
      ...
      if (userClickedPattern[i] !== gamePattern[i]) {
        ...
        var wrong = new Audio('https://github.com/juliotrujilloh/JulioHenriquezSimonGame.github.io/blob/gh-pages/sounds/wrong.mp3');
        wrong.play();
        gameOver();
